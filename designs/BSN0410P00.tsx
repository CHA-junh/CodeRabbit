...
export default function BSN0410P00() {
  return (
          ...
          <tbody>
            ...
            <tr className="form-tr">
              ...
              <td className="form-td">
                <input type="text" className="input-base input-default !w-[40%] text-right" defaultValue="0" /><span className="m-1">/</span> 
                <input type="text" className="input-base input-default !w-[40%] text-right" defaultValue="23,700,000" readOnly /> 원
              </td>
            </tr>
            ...
            <tr className="form-tr">
              ...
              <td className="form-td">
                <input type="text" className="input-base input-default !w-[40%] text-right" defaultValue="0" /><span className="m-1">/</span> 
                <input type="text" className="input-base input-default !w-[40%] text-right" defaultValue="0" /> 원
              </td>
            </tr>
